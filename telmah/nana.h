...
extern const char *filenames[] = {"AVAILABLE.txt",
						   "RENTED.txt",
						   "REPAIR.txt"};
exter const char *car_list[] = {"Available Cars",
						  "Rented Cars",
						  "In-repair Cars"};
static car_list_t **rental_list[] = {&available_head,
									&rented_head,
									&repair_head};
